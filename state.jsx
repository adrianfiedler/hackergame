// state.jsx — global game state, persistence, audio
const STORAGE_KEY = "hackergame:v1";
...
Object.assign(window, { STORAGE_KEY, DEFAULT_STATE, loadState, saveState, Audio, fmtCrypto });
